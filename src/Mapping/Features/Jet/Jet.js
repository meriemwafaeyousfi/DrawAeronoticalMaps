...
const selectType = (mapBrowserEvent) => {
    return click(mapBrowserEvent) || doubleClick(mapBrowserEvent) || mapBrowserEvent.type === 'contextmenu'  ;
    }
...
export const modifyJet = (select, cvl) => {
	return new Modify({
...
export const selectJet = (vectorLayer) => {
	return new Select({
            ...
            filter: function(feature){ return feature.get('feature_type') === 'jet' }
	});
};
