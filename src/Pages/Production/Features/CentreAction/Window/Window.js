...
const handleConfirm = useCallback(() => {
  dispatch(setOption(''))
  dispatch(setModal(''))
  let overlay = createCentreAction(map, mapCoordinate)
      ...
      <Grid container rowSpacing={1} >
        <Grid item xs={6}>
                <Grid container rowSpacing={4} p={2}>
                        <Grid item>
                          <TextField  size="small" type="number"  label=" Vitesse" 
                          InputProps={{
                              inputProps: {  max: 100, min: 0 }
                          }} value= {props.vitesse? props.vitesse : 0}   onChange={handleChangeVitesse}  />
                        </Grid>
                        <Grid item>
                        ...
                        <Grid item >
                          <TextField  size="small"  label="Texte"  value= {props.texte}  onChange={handleChangeTexte} />
                        </Grid> 
             </Grid>        
        </Grid>
        <Grid item xs={6}>
                          ...
                          <StyledToggleButtonGroup
                            ...
                            aria-label="Platform" >
                                <ToggleButton  value={elt[0].name}>
                                    <img src={elt[0].src} style={{ width: "30px", height: "30px" }} ></img>
                                </ToggleButton>
                            
                                <ToggleButton value={elt[1].name}> 
                                    <img src={elt[1].src} style={{ width: "30px", height: "30px" }} ></img>
                                </ToggleButton>
        ...
        <div className="footer">
          <button id="cancelBtn" onClick={handleCancel} >Annuler</button>
